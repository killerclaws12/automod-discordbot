module.exports = {
  ...
  PRESENCE: {
    ...
    MESSAGE: "Do not interact with", // Your bot status message
  },
  DASHBOARD: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "932463595734855690", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
    COOLDOWN: 99999, // Cooldown in seconds between messages
